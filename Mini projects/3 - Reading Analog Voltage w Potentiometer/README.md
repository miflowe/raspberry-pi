Code to measure the voltage provided by the Raspberry Pi Pico W from 0-3.3V. This is done by converting the 16 bit read output to voltage using linear interpolation. 
